...
| 578 | [Get Highest Answer Rate Question](https://leetcode.com/problems/get-highest-answer-rate-question/) | Medium | [Soln.](../master/Basics/578_Get_Highest_Answer_Rate_Question.sql) | | when using ()/() in postgre, the first () need to be transformed to ()::numeric otherwise it will be int
...
| 184 | [Department Highest Salary](https://leetcode.com/problems/department-highest-salary/) | Medium | [Soln.](../master/Join/Simple-Join/184_Department_Highest_Salary.sql) || Watch out for ties
...
| 262 | [Trips and Users](https://leetcode.com/problems/trips-and-users/) | Hard | [Soln.](../master/Join/Simple-Join/262_Trips_and_Users.sql) ||when date col is str, just do col between 'date1' and 'date2'. Forgot END for CASE WHEN
...
| **#** | **Title** | **Difficulty** | **Solution** | **The Trick** | **Mistake** |
|---|---|---|---|---|---|
| 262 | [Trips and Users](https://leetcode.com/problems/trips-and-users/) | Hard | [Soln.](../master/Subquery/Advanced-Subquery/262_Trips_and_Users.sql) || where must be before group by
...
| 585 | [Investments in 2016](https://leetcode.com/problems/investments-in-2016/) | Medium | [Soln.](../master/Subquery/Advanced-Subquery/585_Investments_in_2016.sql) || ROUND() does not work on float by default, need to cast to decimal or numeric; when group by always think about if what you select is aggregated!
